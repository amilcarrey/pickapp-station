...
const KeyWordsModal = ({ open, setOpen }: KeyWordsModalProps) => {
   const router = useRouter()
   const totem = useTotem((s) => s.totem)
   const setKeyWord = useTotem((s) => s.setKeywordNeeded)

   const handleKeyWords = (needed = false) => {
      if (!needed) return router.push('/what')
      setKeyWord(needed)
      return router.push('/what')
   }
   return (
                     ...
                     <Dialog.Panel className="relative  transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                        <div>
                           ...
                           <div className="text-center">
                              ...
                              >
                                 ¿Necesitas una palabra clave para la entrega?
                              </Dialog.Title>
